...
import Stack from "./";
declare abstract class Domain extends EventTarget {
    ...
    abstract init: (stack: Stack | null, name: string, type: "domain", relation: typeof this.relation, sourceClass: string, targetClass: string, description?: string) => void;
    static get: (stack: Stack, name: string, type: "domain", relation: "1:1" | "1:N" | "N:1" | "N:N", sourceClass: string, targetClass: string, description?: string, schema?: DomainModel["schema"]) => Domain;
    static create: (stack: Stack, name: string, type: "domain", relation: "1:1" | "1:N" | "N:1" | "N:N", sourceClass: string, targetClass: string, description?: string, schema?: DomainModel["schema"]) => Promise<Domain>;
